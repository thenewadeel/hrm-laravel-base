...
test('subscription manager can create subscription', function () {
    ...
    Livewire::actingAs($user)
        ->test(\App\Livewire\Membership\SubscriptionManager::class, ['member' => $member])
        ...
        ->assertDispatched('subscription-created')
        ->assertDispatched('show-notification', ['message' => 'Subscription created successfully', 'type' => 'success']);
...
test('subscription manager can renew subscription', function () {
    ...
    Livewire::actingAs($user)
        ...
        ->assertDispatched('show-notification', ['message' => 'Subscription renewed successfully', 'type' => 'success']);
});
...
test('subscription manager can cancel subscription', function () {
    ...
    Livewire::actingAs($user)
        ...
        ->assertDispatched('show-notification', ['message' => 'Subscription cancelled successfully', 'type' => 'success']);
