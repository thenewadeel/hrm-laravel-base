<nav x-data="{ open: false }" class="surface border-b border-secondary">
    {{-- In resources/views/layouts/app.blade.php or navigation --}}
    {{-- @auth
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false"
                            class="absolute mt-2 w-48 rounded-md shadow-lg surface ring-1 ring-black ring-opacity-5 z-50">
                            <div class="py-1">
                                <x-dropdown-link href="{{ route('inventory.items.index') }}">
                                    📦 Items
                                </x-dropdown-link>
                                <x-dropdown-link href="{{ route('inventory.stores.index') }}">
                                    🏪 Stores
                                </x-dropdown-link>
                                <x-dropdown-link href="{{ route('inventory.transactions.index') }}">
                                    📋 Transactions
                                </x-dropdown-link>
                                <div class="border-t border-secondary"></div>
                                <x-dropdown-link href="{{ route('inventory.reports.stock-levels') }}">
                                    📊 Reports
                                </x-dropdown-link>
                            </div>
                        </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('inventory.stores.index') }}" :active="request()->routeIs('inventory.stores.*')">
                🏪 Stores
            </x-responsive-nav-link>
            ...
            @if (request()->routeIs('demo.*'))
                <x-nav-link href="{{ route('demo.inventory-components') }}" :active="request()->routeIs('demo.inventory-components')">
                    🎨 Components Demo
                </x-nav-link>
            @endif
        </div>
            ...
            @auth
                ...
                <div class="mt-3 space-y-1">
                    ...
                    @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                        ...
                        <!-- Team Settings -->
                        <x-responsive-nav-link href="{{ route('teams.show', Auth::user()->currentTeam->id ?? -1) }}"
