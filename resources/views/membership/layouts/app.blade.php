...
<head>
    ...
    <title>@yield('title', 'Membership Management') - HRM Laravel Base</title>
...
<body class="font-sans antialiased">
                        ...
                        <div class="flex">
                            ...
                            <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                                <a href="{{ route('dashboard') }}" 
                                   class="inline-flex items-center px-1 pt-1 border-b-2 {{ request()->routeIs('dashboard') ? 'border-indigo-500 text-gray-900 dark:text-white' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300' }} text-sm font-medium">
                                    Dashboard
                                </a>
    ...
    <!-- Notification System -->
    <div x-data="{ notifications: [] }" x-init="window.addEventListener('livewire:init', () => {
