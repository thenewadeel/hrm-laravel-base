                ...
                <form method="POST" action="{{ route('hr.positions.update', $position) }}">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <!-- Default Roles -->
                            <div>
                                <label class="block text-sm font-medium text-primary mb-2">Default Roles</label>
                                <p class="text-xs text-secondary mb-2">Automatically granted whenever this position is assigned to an employee.</p>
