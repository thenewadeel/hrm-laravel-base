        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-secondary mt-1">
                    Create and manage employee records and information
                </p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="surface shadow overflow-hidden sm:rounded-md">
                <ul class="divide-y divide-secondary">
                    <!-- Employee Row -->
                    <li>
                        <a href="{{ route('hr.employees.show', 1) }}" class="block hover:bg-tertiary">
                            <div class="px-4 py-4 sm:px-6">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-primary">John Smith</div>
                                            <div class="text-sm text-secondary">john.smith@company.com</div>
                                        </div>
                                    </div>
                                    <div class="flex items-center space-x-4">
                                        <div class="text-sm text-primary">Senior Developer</div>
