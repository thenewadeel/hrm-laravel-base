                    ...
                    <ol class="flex items-center space-x-4">
                        ...
                        <li>
                            <div class="flex items-center">
                                <x-heroicon-m-chevron-right class="flex-shrink-0 h-5 w-5 text-muted" />
                            ...
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                    ...
                                    <div class="flex space-x-2">
                                        <select id="shift_id" name="shift_id"
                                            ...
                                            @foreach($shifts as $shift)
                                                <option value="{{ $shift->id }}" data-working-hours="{{ $shift->working_hours }}" {{ old('shift_id', $employee->shift_id) == $shift->id ? 'selected' : '' }}>
                                ...
                                <div>
                                    ...
                                    <select id="pay_frequency" name="pay_frequency"
                                        class="mt-1 block w-full border-secondary rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        <option value="monthly" {{ old('pay_frequency', $employee->pay_frequency ?? 'monthly') == 'monthly' ? 'selected' : '' }}>Monthly</option>
