    ...
    <x-slot name="content">
        ...
        @if ($this->enabled)
            @if ($showingQrCode)
                ...
                @if ($showingConfirmation)
                    <div class="mt-4">
                        ...
                        <x-form.input id="code" type="text" name="code" class="block mt-1 w-1/2"
            ...
            @if ($showingRecoveryCodes)
                ...
                <div
                    class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-tertiary text-primary rounded-lg">
