                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="date" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Date of
                            Entry</label>
                        <input type="date" wire:model="entry_date" required
                ...
                <div class="space-y-6">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="text-sm">
                                <span class="font-medium">Debits:</span>
                                <span class="{{ !$is_balanced ? 'text-red-600' : 'text-green-600' }}">
                    ...
                    @foreach ($transactions as $index => $transaction)
                        <div class="grid grid-cols-5 gap-4 items-start">
                            <div class="col-span-2">
                                ...
                                <select wire:model="transactions.{{ $index }}.account_id" required
                                ...
                                @if (!empty($transaction['error']))
                                    <span class="text-red-500 text-xs">{{ $transaction['error'] }}</span>
                                @endif
                            </div>
                            <div>
                                <label for="debit-{{ $index }}" class="sr-only">Debit</label>
                                <input type="number" step="0.01"
                                    wire:model="transactions.{{ $index }}.debit"
                                    class="block w-full rounded-md border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01"
                                    wire:model="transactions.{{ $index }}.credit"
                                    class="block w-full rounded-md border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
