            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
                <div class="p-6">
                    ...
                    @if($availableFinancialYears->count() > 0)
                        <div class="mb-6 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                            <div class="flex items-start">
                                <x-heroicon-o-information-circle class="w-5 h-5 text-yellow-600 dark:text-yellow-400 mt-0.5 mr-2" />
                                <div class="flex-1">
                    ...
                    <div class="mb-6 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
                        <div class="flex items-start">
                            <x-heroicon-o-exclamation-triangle class="w-5 h-5 text-red-600 dark:text-red-400 mt-0.5 mr-2" />
                            <div class="flex-1">
