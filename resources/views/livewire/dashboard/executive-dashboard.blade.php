<div>
                ...
                <div class="flex items-center gap-2">
                    <button type="button"
                        ...
                        <x-heroicon-o-arrow-path class="h-5 w-5"
                                                 wire:loading.remove
                                                 wire:target="refresh" />
                        <x-heroicon-o-arrow-path class="hidden h-5 w-5 animate-spin"
                                                 wire:loading
                                                 wire:target="refresh" />
                    </button>
                    <button type="button"
    ...
    <section class="mt-6 dashboard-grid"
             data-widget-grid
        ...
        @foreach ($layout as $key)
            ...
            @if ($widget)
                <x-dashboard.widget-card :key="$key" :widget="$widget" :activity="$activity" />
            @endif
        @endforeach
    </section>
</div>