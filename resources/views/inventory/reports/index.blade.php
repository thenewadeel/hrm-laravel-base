    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <x-inventory.stock-card title="Total Transactions" value="{{ $reportData['total_transactions'] ?? 0 }}"
                    ...
                    description="In selected period" icon="📋" />

                <x-inventory.stock-card title="Items Moved" value="{{ $reportData['total_quantity'] ?? 0 }}"
                    ...
                    description="Units transferred" icon="🔄" />
                ...
                <x-inventory.stock-card title="Total Value"
                    ...
                    description="Transaction value" icon="💰" />

                <x-inventory.stock-card title="Avg. Transaction"
                    ...
                    description="Per transaction" icon="📈" />
            </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                                <div>
                                    ...
                                    <div class="text-sm text-blue-700">{{ $reportData['most_active_item'] ?? 'N/A' }}
                                    </div>
                                </div>
                            ...
                            <div class="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                                <div>
                                    ...
                                    <div class="text-sm text-green-700">
                                        ${{ number_format(($reportData['highest_value_tx'] ?? 0) / 100, 2) }}</div>
                                </div>
                                <div class="text-2xl">💰</div>
                            </div>
                            ...
                            <div class="flex justify-between items-center p-3 bg-yellow-50 rounded-lg">
                                <div>
                                    ...
                                    <div class="text-sm text-yellow-700">{{ $reportData['busiest_store'] ?? 'N/A' }}
                                    </div>
                                </div>
                                <div class="text-2xl">🏪</div>
                            </div>
                            ...
                            <div class="flex justify-between items-center p-3 bg-red-50 rounded-lg">
                                <div>
                                    ...
                                    <div class="text-sm text-red-700">{{ $reportData['reorder_items_count'] ?? 0 }}
                                        items</div>
                                </div>
