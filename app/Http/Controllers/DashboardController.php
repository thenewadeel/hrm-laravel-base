...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        // Get dashboard data
        $stores = Store::forOrganization($organization->id)->withCount('items')->get(); // $organization->stores()->withCount('items')->get();
        $totalItems = Item::ofOrganization($organization->id)->count();
        $lowStockItems = Item::ofOrganization($organization->id)
        ...
        $items = Item::ofOrganization($organization->id)->get();
        // dd([
