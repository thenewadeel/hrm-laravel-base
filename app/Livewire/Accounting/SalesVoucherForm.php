...
class SalesVoucherForm extends Component
{
    ...
    public function createSalesVoucher(): void
    {
        $this->validate();
        ...
        try {
            ...
            $this->dispatch('sales-voucher-created', voucher: $voucher);
            $this->dispatch('show-message', message: 'Sales voucher created successfully!', type: 'success');

            // Reset form
            $this->mount();
        } catch (\Exception $e) {
            $this->dispatch('show-message', message: 'Error creating sales voucher: '.$e->getMessage(), type: 'error');
        }
    }

    public function render()
    {
        return view('livewire.accounting.sales-voucher-form', [
